...
const EXTRA = {
  ru: {
    ...
    messengerButton: 'Войти через Serpmonn Messenger',
    messengerModalTitle: 'Вход через Serpmonn Messenger',
    messengerModalHint: 'Отсканируйте QR в мессенджере',
    messengerCodeLabel: 'Код',
    messengerWaiting: 'Ожидаем подтверждение…',
    messengerCancel: 'Отмена',
  ...
  en: {
    ...
    messengerButton: 'Sign in with Serpmonn Messenger',
    messengerModalTitle: 'Sign in with Serpmonn Messenger',
    messengerModalHint: 'Scan the QR code in the messenger',
    messengerCodeLabel: 'Code',
    messengerWaiting: 'Waiting for confirmation…',
    messengerCancel: 'Cancel',
...
for (const locale of locales) {
  ...
  output[locale] = {
    ...
    vkButton: e.vkButton,
    messengerButton: e.messengerButton || EXTRA.en.messengerButton,
    messengerModalTitle: e.messengerModalTitle || EXTRA.en.messengerModalTitle,
    messengerModalHint: e.messengerModalHint || EXTRA.en.messengerModalHint,
    messengerCodeLabel: e.messengerCodeLabel || EXTRA.en.messengerCodeLabel,
    messengerWaiting: e.messengerWaiting || EXTRA.en.messengerWaiting,
    messengerCancel: e.messengerCancel || EXTRA.en.messengerCancel,

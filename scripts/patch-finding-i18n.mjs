...
const RU = {
  ...
  'finding.noInbox': 'Пока нет диалогов. Нажмите «Написать», чтобы начать.',
  ...
  'finding.inboxHint': 'Личная переписка с другими пользователями Serpmonn.',
  ...
  'finding.dmWritePlaceholder': 'Написать сообщение…',
  'finding.dmSendButton': 'Отправить',
  'finding.dmFindingPreview': 'Находка: {query}',
  'finding.dmFindingAttachment': 'Находка',
  'finding.dmEmptyThread': 'Сообщений пока нет. Напишите первым!',
  'finding.dmSendFailed': 'Не удалось отправить сообщение',
  'finding.dmMessageOnly': 'Сообщение',
  'finding.dmYouPrefix': 'Вы',
  'finding.dmAttachFinding': 'Отправить находку',
  'finding.dmAttachFindingShort': 'Находка',
  'finding.dmPickFindingTitle': 'Выберите находку',
  'finding.dmPickFindingHint': 'Выберите сохранённую находку из профиля, чтобы отправить в чат.',
  'finding.dmNoFindingsToAttach': 'Нет сохранённых находок для отправки.',
  'finding.dmNewMessage': 'Написать',
  'finding.dmNewMessagePlaceholder': 'Найти @username…',
  'finding.dmNewMessageOpen': 'Открыть чат',
  'finding.activityTitle': 'Активность',
  'finding.activityIntro': 'Здесь сообщения и уведомления. Непрочитанное отмечено на вкладках.',
  'finding.dmEmptyInboxHint': 'Начните личный чат или отправьте находку знакомому пользователю.',
  'finding.notificationsEmptyHint': 'Здесь появятся комментарии и новые находки от тех, на кого вы подписаны.',
  'finding.notificationTypeComment': 'Комментарий',
  'finding.notificationTypeFinding': 'Новая находка',
};

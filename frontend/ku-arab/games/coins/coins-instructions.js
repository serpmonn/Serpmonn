// coins-instructions.js - Скрипт показа инструкций для игры "Монетки"
...
(function() {
    ...
    function showInstructions() {
        ...
        h.textContent = 'Как играть — Монетки';
        ...
        btn.onclick = function() { 
            ...
            localStorage.setItem('game_instructions_coins_shown', '1'); // Сохраняем флаг что инструкции показаны
        };

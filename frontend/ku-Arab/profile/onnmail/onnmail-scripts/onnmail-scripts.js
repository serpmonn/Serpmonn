...
const handleRegister = async (e) => {                                                                                         // Определяем функцию обработки регистрации
    ...
    try {                                                                                                                     // Начинаем блок обработки ошибок
        ...
        // Успешная регистрация - редирект Roundcube
        console.log('Регистрация успешна, редирект на https://serpmonn.ru/mail/');                                            // Логируем успешную регистрацию
        window.location.href = 'https://serpmonn.ru/mail/';                                                                   // Перенаправляем на Mailcow
    } catch (error) {                                                                                                         // Обрабатываем возможные ошибки

// snake.js — сайт Serpmonn (геймплей как в Яндекс-билде, реклама сайта сохранена)
(function () {
  'use strict';
  ...
  function draw() {
    ctx.fillStyle = cssVar('--grid', '#1b1b1d');

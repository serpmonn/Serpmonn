...
router.get('/get', verifyToken, profileLimiter, getUserProfile);                                                          // Определяем GET маршрут для профиля
router.get('/info', verifyToken, profileLimiter, getUserInfo);                                                            // Определяем GET маршрут для информации
router.post('/update', verifyToken, profileLimiter, updateUserProfile);                                                   // Определяем POST маршрут для обновления
